---
name: spike
description: "Throwaway experiments to validate an idea before build. 又名「探针」。"
version: 1.1.0
...
**Parallel comparison spikes (002a / 002b) — delegate.** When two approaches can run in parallel and both need real engineering (not 10-line prototypes), fan out with `delegate_task`. Tier: ⚡ **莉闪** (implementation spikes are routine development work).
