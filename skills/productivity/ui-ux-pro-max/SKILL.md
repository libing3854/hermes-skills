---
name: ui-ux-pro-max
description: "设计智能引擎，提供 UI/UX 设计指南。当用户需要 UI 设计、UX 设计、风格选择、配色方案、字体搭配、图表设计时触发。原名 UI/UX Pro Max，适配自 nextlevelbuilder/ui-ux-pro-max-skill。中文名「设计百宝箱」。"
version: 0.1.0
author: Lily (adapted from nextlevelbuilder)
license: MIT
metadata:
  hermes:
    tags: [design, ui, ux, frontend, productivity]
    ...
    source:
      ...
      file_hash: 9bd26c52dfd10dfd613dd3cc85df217dc25a172e380bde41fdfa6fedda288b2a
